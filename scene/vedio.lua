...
local slidebar = require("scene.vedio.vedioslidebar")
local content = require("scene.vedio.vediocontent")
...
function scene:create( event )
	...
	slideGroup = slidebar.createSlideBar()
...
function scene:show( event )
	...
	elseif ( phase == "did" ) then
		...
		tabBarGroup = tabBar.themeChooser(2)
